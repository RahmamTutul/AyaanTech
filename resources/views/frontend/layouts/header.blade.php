    ...
    <nav>
        <div class="wrapper content">
          ...
          <ul class="nav-links">
            ...
            <li>
              <a href="#packeges" class="desktop-item">Packeges</a>
              <input type="checkbox" id="showDrop">
              <label for="showDrop" class="mobile-item">Packeges</label>
              <ul class="drop-menu">
                <li><a href="#packeges">Packeges 1</a></li>
                <li><a href="#packeges">Packeges 2</a></li>
                <li><a href="#packeges">Packeges 3</a></li>
                <li><a href="#packeges">Packeges 4</a></li>
              </ul>
            </li>
